 ...
 * on 2016-03-15 at 10:24:47 UTC 
 * Modify at your own risk.
 */

package com.example.myapplication.backend.jokeApi;
...
public class JokeApi extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
   ...
   * @since 1.7
   */
  public static final String DEFAULT_ROOT_URL = "https://builditbigger-1251.appspot.com/_ah/api/";
   ...
   * @since 1.7
   */
  public static final String DEFAULT_SERVICE_PATH = "jokeApi/v1/fetchJoke/";
   ...
   * @return the request
   */
  public FetchJoke fetchJoke(java.lang.String joke) throws java.io.IOException {
    FetchJoke result = new FetchJoke(joke);
    initialize(result);
    return result;
  }

  public class FetchJoke extends JokeApiRequest<com.example.myapplication.backend.jokeApi.model.MyBean> {
     ...
     * @since 1.13
     */
    protected FetchJoke(java.lang.String joke) {
      super(JokeApi.this, "POST", REST_PATH, null, com.example.myapplication.backend.jokeApi.model.MyBean.class);
    ...
    public FetchJoke setJoke(java.lang.String joke) {
      this.joke = joke;
      return this;
    }
